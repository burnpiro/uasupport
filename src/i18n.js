...
const resources = {
  en: {
    translation: {
      ...
      'Form Invalid - Social':
        'You have to add at least one contact type (email, phone, FB)',
      ...
      AidName: 'Name',
      AidType: 'Aid Type',
      'health-aid': 'Medical Aid',
      'standard-aid': 'Other Aid',
      'all-aid': 'All',
  ...
  ru: {
    translation: {
      ...
      AidName: "ім'я",
      AidType: 'Тип довідки',
      'health-aid': 'Медична допомога',
      'standard-aid': 'Натуральна допомога',
